...
class KontakRepository(application: Application) {
    ...
    companion object {
        private class InsertKontakAsyncTask(kontakDao: KontakDao) :
            AsyncTask<Kontak, Unit, Unit>() {
        ...
        private class UpdateKontakAsyncTask(kontakDao: KontakDao) :
            AsyncTask<Kontak, Unit, Unit>() {
            val kontakDao = kontakDao
            override fun doInBackground(vararg p0: Kontak?) {
        ...
        private class DeleteKontakAsyncTask(kontakDao: KontakDao) :
            AsyncTask<Kontak, Unit, Unit>() {
            val kontakDao = kontakDao
            override fun doInBackground(vararg p0: Kontak?) {
        ...
        private class DeleteAllKontakAsyncTask(kontakDao: KontakDao) :
